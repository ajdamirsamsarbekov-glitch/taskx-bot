...
const WEBHOOK_URL = process.env.WEBHOOK_URL || `https://tele.goldenherd.com/tg/webhook/${BOT_TOKEN.split(':')[0]}`;
const SUPABASE_URL = process.env.SUPABASE_URL || 'https://hjoosjstmginrpatkvbm.supabase.co';
const SUPABASE_KEY = process.env.SUPABASE_ANON_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imhqb29zanN0bWdpbnJwYXRrdmJtIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc5MDA3NTI5MywiZXhwIjoyMTA1NjUxMjkzfQ.wuMdC1ZsckIUB5PKjRdNH1vaJLSaRxjzevBxay2DbBI';
...
(async () => {
  ...
  app.listen(PORT, async () => {
    ...
    // Set webhook
    const response = await fetch(`https://api.telegram.org/bot${BOT_TOKEN}/setWebhook?url=${encodeURIComponent(WEBHOOK_URL)}`);
